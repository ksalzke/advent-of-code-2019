def drawWire(path_string, first_wire):
    path_list = path_string.split(",")
    shortest_distance = 0

    list_of_coordinates = []  # [x, y], string
    ...
    for i in range(length):
        ...
        for i in range(number):
            steps_taken += 1
            current_coordinates = [
                current_coordinates[0]+x_adjust, current_coordinates[1]+y_adjust]
            if first_wire:
                list_of_coordinates.append(current_coordinates)
            elif current_coordinates in first_wire_coords:
                print("intersection", current_coordinates)
                print("first wire steps", first_wire_coords.index(
                    current_coordinates) + 1)
                print("second wire steps", steps_taken)
                distance = steps_taken + \
                    first_wire_coords.index(current_coordinates) + 1
