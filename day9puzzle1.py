...
def run_intcode(intcode):
    ...
    while opcode != 99 and pos < len(intcode_list):
        # print(instruction)
        # get mode - 0 is position mode, 1 is immediate mode, 2 is relative mode
        # print(relative_base)
        try:
        ...
        try:
            ...
            elif third_mode is 1:
                third = pos + 3
            elif third_mode is 2:
                third = intcode_list[pos + 3] + relative_base
        except IndexError:
            pass
        ...
        if opcode == 1:
            ...
            relative_base += intcode_list[first]
            pos += 2
        else:
            print("opcode ", opcode, "?")
            print(intcode_list)
